---
title: "Welcome to Regression II!"
format: 
  live-html:
    toc: true
    toc-depth: 4
...
| :---:   | :---: | :---: |
| Link Functions and Count Regression | [`lecture1` notes](notes/lecture1-glm-link-functions-and-count-regression.qmd) | [Chapter 1 (*Review of Multiple Linear Regression*): BMLR](https://bookdown.org/roback/bookdown-BeyondMLR/ch-MLRreview.html) (*as a review*) <br> [Chapter 6 (*Logistic Regression*): BMLR](https://bookdown.org/roback/bookdown-BeyondMLR/ch-logreg.html) (*as a review*) <br> [Chapter 5 (*Generalized Linear Models: A Unifying Theory*): BMLR](https://bookdown.org/roback/bookdown-BeyondMLR/ch-glms.html#learning-objectives-4) (*short chapter*) <br> [Chapter 4 (*Poisson Regression*): BMLR](https://bookdown.org/roback/bookdown-BeyondMLR/ch-poissonreg.html) |
| Model Selection and Multinomial Logistic Regression | [`lecture2` notes](notes/lecture2_glm_model_selection_multinomial.qmd) | [Chapter 2 (Beyond Least Squares: Using Likelihoods): BMLR](https://bookdown.org/roback/bookdown-BeyondMLR/ch-beyondmost.html#summary-of-model-building) <br> [Faraway: 5.1 (Multinomial Logit Model)](https://gw2jh3xr2c.search.serialssolutions.com/?sid=sersol&SS_jc=TC0000296029&title=Extending%20the%20Linear%20Model%20with%20R%3A%20Generalized%20Linear%2C%20Mixed%20Effects%20and%20Nonparametric%20Regression%20Models) |
| Ordinal Logistic Regression | [`lecture3` notes](notes/lecture3_glm_ordinal_regression.qmd) | [Faraway: 5.3 (Ordinal Multinomial Responses)](https://gw2jh3xr2c.search.serialssolutions.com/?sid=sersol&SS_jc=TC0000296029&title=Extending%20the%20Linear%20Model%20with%20R%3A%20Generalized%20Linear%2C%20Mixed%20Effects%20and%20Nonparametric%20Regression%20Models) |
| Linear Mixed-effects Models | [`lecture4` notes](notes/lecture4_linear_mixed_effects_models.qmd) | [Initial motivation (ISL): 3.3.3 Potential Problems (*2. Correlation of Error Terms*)](https://www.statlearning.com) <br> [Chapter 8 (*Introduction to Multilevel Models*): BMLR (from 8.1 to 8.8)](https://bookdown.org/roback/bookdown-BeyondMLR/ch-multilevelintro.html) |
| Survival Analysis | [`lecture5` notes](notes/lecture5_survival_analysis.qmd) |See Kleinbaum and Klein (2005) in [reference material](#reference-material) |
| Local Regression | [`lecture6` notes](notes/lecture6_local_regression.qmd) | [ISL](https://www.statlearning.com) 7.2. Step Functions <br> [ISL](https://www.statlearning.com) 7.6. Local Regression |
| Quantile Regression | [`lecture7` notes](notes/lecture7_quantile_regression.qmd) | [Fahrmeir (2013)](https://gw2jh3xr2c.search.serialssolutions.com/?sid=sersol&SS_jc=TC0000904267&title=Regression%20Models%2C%20Methods%20and%20Applications) <br> 10. Quantile Regression (except 10.2.2. Bayesian Quantile Regression) |
| Missing Data | [`lecture8` notes](notes/lecture8_missing_data.qmd) | See van Buuren (2012) in [reference material](#reference-material) |

## Regression Mind Map

[**Here**](notes/appendix-reg-mindmap.qmd) is a mind map we created to summarize all regression models to be covered in this course.

## Cheat sheet

[**Here**](notes/appendix-reg-cheatsheet.qmd) is a cheat sheet we created to summarize the main formulas and concepts covered in DSCI 562.
